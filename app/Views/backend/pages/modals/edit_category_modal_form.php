<div class="modal fade" id="edit-category-modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;" data-backdrop="static">
    <div class="modal-dialog modal-dialog-centered">
        <?php $validation =  \Config\Services::validation(); ?>
        <form class="modal-content" action="<?= route_to('update-category') ?>" method="post" id="update-category-form">
