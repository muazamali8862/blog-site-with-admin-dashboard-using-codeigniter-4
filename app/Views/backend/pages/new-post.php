...
<form action="<?= route_to('create-post') ?>" method="post" enctype="multipart/form-data" autocomplete="off" id="addpostform">
    <?= csrf_field(); ?>
            ...
            <div class="card card-box mb-2">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="content" id="content" placeholder="Enter Post content" class="form-control" cols="30" rows="10"></textarea>
                    </div>
            ...
            <div class="card card-box mb-2">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="meta_description" id="meta_description" class="form-control" placeholder="Enter Post meta description" cols="30" rows="10"></textarea>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card card-box mb-2">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="tags" id="tags" placeholder="Enter tags" class="form-control" data-role="tagsinput">
                    </div>
